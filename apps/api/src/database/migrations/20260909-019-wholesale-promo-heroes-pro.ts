...
export class WholesalePromoHeroesPro1757430000019 implements MigrationInterface {
  name = 'WholesalePromoHeroesPro1757430000019';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "site_content_wholesale_promo_pro_backups" (
    ...
    `);
    await queryRunner.query(`
      INSERT INTO "site_content_wholesale_promo_pro_backups" ("channel", "pageKey", "heroProps")
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      SET "blocks" = (
          ...
          "updatedAt" = now()
      FROM "site_content_wholesale_promo_pro_backups" backup
      WHERE backup."channel" = sc."channel"
        AND backup."pageKey" = sc."pageKey"
        AND sc."channel" = 'WHOLESALE'
        AND sc."pageKey" = 'home'
    `);
    await queryRunner.query(`DROP TABLE IF EXISTS "site_content_wholesale_promo_pro_backups"`);
  }
}
