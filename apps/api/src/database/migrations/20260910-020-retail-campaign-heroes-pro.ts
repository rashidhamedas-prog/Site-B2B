...
export class RetailCampaignHeroesPro1757510000020 implements MigrationInterface {
  name = 'RetailCampaignHeroesPro1757510000020';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "site_content_retail_campaign_pro_backups" (
    ...
    `);
    await queryRunner.query(`
      INSERT INTO "site_content_retail_campaign_pro_backups" ("channel", "pageKey", "heroProps")
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      SET "blocks" = (
          ...
          "updatedAt" = now()
      FROM "site_content_retail_campaign_pro_backups" backup
      WHERE backup."channel" = sc."channel"
        AND backup."pageKey" = sc."pageKey"
        AND sc."channel" = 'RETAIL'
        AND sc."pageKey" = 'home'
    `);
    await queryRunner.query(`DROP TABLE IF EXISTS "site_content_retail_campaign_pro_backups"`);
  }
}
