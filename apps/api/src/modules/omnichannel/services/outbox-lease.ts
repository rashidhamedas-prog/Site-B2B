...
export const PHASE3_EVENT_TYPES = [
  ...
  OUTBOX_EVENT_TYPES.FULFILLMENT_PENDING_ACCEPT_NOTIFICATION,
  OUTBOX_EVENT_TYPES.FULFILLMENT_SHIPPED_NOTIFICATION,
  OUTBOX_EVENT_TYPES.AFFILIATE_POSTBACK_REQUESTED,
  OUTBOX_EVENT_TYPES.CUSTOMER_REGISTERED_MARKETING,
  OUTBOX_EVENT_TYPES.CUSTOMER_APPROVED_MARKETING,
  OUTBOX_EVENT_TYPES.MARKETING_SEND_REQUESTED,
  OUTBOX_EVENT_TYPES.MARKETING_CAMPAIGN_DISPATCH,
] as const;
