          ...
          slides: [
            {
              ...
              headline: 'لینن نرم، امضای ترنم',
              headlineAccent: 'ترنم',
              body: 'مانتو شومیزی لینن زنانه — دوخت تولیدی، پارچه‌های لطیف، ارسال سریع به سراسر ایران.',
              imageUrl: 'https://poshaktaranom.com/media/products/1785327343829-0d995c3ef9087.jpg',
            ...
            {
              brandEyebrow: 'کالکشن فصل',
              headline: 'کت و رویه — استایل بی‌زمان',
              headlineAccent: 'بی‌زمان',
              body: 'کت شنل و رویه‌های فصل برای استایل روزمره و رسمی؛ کیفیت تولیدی ترنم.',
              imageUrl: 'https://poshaktaranom.com/media/products/1785328037217-7d58602c99775.jpg',
              ctaLabel: 'مشاهده جدیدترین‌ها',
              ctaHref: '/retail/products',
              ctaSecondaryLabel: 'مشاهده مجموعه',
            ...
            {
              brandEyebrow: 'ست‌های آماده',
              headline: 'ست‌های آماده برای هر روز',
              headlineAccent: 'هر روز',
              body: 'سوئیشرت و شلوار هماهنگ — انتخاب سریع، راحتی تمام‌روز، ارسال از مشهد.',
              imageUrl: 'https://poshaktaranom.com/media/products/1785328299770-a911ebcc46c65.jpg',
              ctaLabel: 'مشاهده جدیدترین‌ها',
              ctaHref: '/retail/products',
              ctaSecondaryLabel: 'مشاهده مجموعه',
