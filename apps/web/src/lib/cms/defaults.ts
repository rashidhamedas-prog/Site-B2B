      ...
      slides: [
        {
          ...
          body: 'مانتو شومیزی لینن و کتان کارگاهی — قیمت کارخانه، کیفیت یکنواخت، ارسال عمده به سراسر ایران.',
          imageUrl: 'https://poshaktaranom.com/media/products/1785327343829-0d995c3ef9087.jpg',
        ...
        {
          brandEyebrow: 'پوشاک ترنم',
          headline: 'پرفروش‌های بوتیک‌ها\nموجودی عمده\nآماده ارسال',
          headlineAccent: 'آماده ارسال',
          body: 'کت و رویه‌های فصل — مدل‌های پرگردش برای ویترین، با حداقل سفارش شفاف و پشتیبانی فروش.',
          imageUrl: 'https://poshaktaranom.com/media/products/1785328037217-7d58602c99775.jpg',
          ctaLabel: 'مشاهده محصولات',
          ctaHref: '/products',
          ctaSecondaryLabel: 'ثبت‌نام عمده‌فروش',
          ctaSecondaryHref: '/portal/register',
        ...
        {
          brandEyebrow: 'پوشاک ترنم',
          headline: 'ست‌های سودآور\nبرای ویترین شما',
          headlineAccent: 'برای ویترین شما',
          body: 'ست سوئیشرت و شلوار با حاشیه سود مناسب بوتیک — بسته‌بندی عمده و ارسال سریع از مشهد.',
          imageUrl: 'https://poshaktaranom.com/media/products/1785328299770-a911ebcc46c65.jpg',
          ctaLabel: 'مشاهده محصولات',
          ctaHref: '/products',
          ctaSecondaryLabel: 'ثبت‌نام عمده‌فروش',
          ctaSecondaryHref: '/portal/register',
          ...
          slides: [
            {
              ...
              headline: 'نسیم تازهٔ استایل روزمره',
              headlineAccent: 'استایل روزمره',
              body: 'رویه‌های سبک و خوش‌فرم برای هر روز — دوخت تولیدی ترنم، ارسال سریع به سراسر ایران.',
              imageUrl: 'https://poshaktaranom.com/media/products/1785363376227-1a59e82dc89e5.png',
            ...
            {
              brandEyebrow: 'سفیدِ همیشه شیک',
              headline: 'سادگی درخشان، امضای ترنم',
              headlineAccent: 'ترنم',
              body: 'شومیز و رویه‌های روشن برای استایلی تمیز و شهری — کیفیت پارچه، دوخت دقیق.',
              imageUrl: 'https://poshaktaranom.com/media/products/1785363378757-3ca9f900d6eee.png',
              ctaLabel: 'مشاهده جدیدترین‌ها',
              ctaHref: '/retail/products',
              ctaSecondaryLabel: 'مشاهده مجموعه',
              ctaSecondaryHref: '/retail/collections',
            ...
            {
              brandEyebrow: 'انتخاب شیک',
              headline: 'کت رسمی برای هر مناسبت',
              headlineAccent: 'هر مناسبت',
              body: 'از دورهمی تا روز اداری — کت‌های خوش‌دوخت با جزئیات ظریف طلایی برند.',
              imageUrl: 'https://poshaktaranom.com/media/products/1785363381385-f1a713aeae23e.png',
              ctaLabel: 'مشاهده جدیدترین‌ها',
              ctaHref: '/retail/products',
              ctaSecondaryLabel: 'مشاهده مجموعه',
              ctaSecondaryHref: '/retail/collections',
