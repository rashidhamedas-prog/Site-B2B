    ...
    items?.length
      ...
      : [
          ...
          },
          {
            ...
            answer:
              'پرداخت آنلاین از طریق زرین‌پال در دسترس است.',
          },
          {
            question: 'این همان تولیدی عمده است؟',
            answer:
              'بله. همان کارگاه ترنم در مشهد است؛ این سایت برای خرید تکی است و بوتیک‌داران از poshaktaranom.com سفارش می‌دهند.',
          },
        ];
