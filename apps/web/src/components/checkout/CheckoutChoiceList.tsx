...
import type { CheckoutAppearance, CheckoutChoiceOption, CheckoutPaymentIcon } from '@/lib/checkout-payment-ui';
        ...
        return (
          ...
          >
            <span
              className={cn(
                ...
                selected
                  ...
                  : retail
                    ? 'bg-white text-[var(--retail-primary)] ring-1 ring-[var(--retail-border)]'
            ...
            <span className="min-w-0 flex-1">
              ...
              <span className={cn('mt-0.5 block text-xs leading-6', retail ? 'text-[var(--retail-muted)]' : 'text-gray-500')}>
                {option.description}
              </span>
              {option.hint && selected ? (
                <span className={cn('mt-1 block text-[11px] font-medium', retail ? 'text-[var(--retail-primary)]' : 'text-primary')}>
                  {option.hint}
                </span>
              ) : null}
