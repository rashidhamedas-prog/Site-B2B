  ...
  if (resolved === 'GONE') {
    return (
      <div className="mx-auto max-w-xl px-4 py-24 text-center">
        <h1 className="mb-3 text-2xl font-extrabold text-stone-900">مطلب حذف شده است</h1>
        <p className="mb-6 text-sm text-stone-500">این صفحه دیگر در دسترس نیست (۴۱۰).</p>
        <Link href="/blog" className="inline-block rounded-xl bg-[#4a2c1a] px-4 py-2 text-sm text-white">
          بازگشت به وبلاگ
        </Link>
      </div>
    );
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        ...
        {post.primaryCta && (
          <div className="mt-10 rounded-2xl bg-[#4a2c1a] p-8 text-center text-white">
            ...
            {post.primaryCta.description && <p className="mb-5 text-sm text-white/70">{post.primaryCta.description}</p>}
            <Link
