...
- [ ] نوع پلتفرم در پنل ترب را از «وبزی» به **سایر / فید XML** تغییر دهید (سایت دیگر روی وبزی نیست؛ اگر فیلد قفل است به پشتیبانی ترب تیکت بزنید)  
- [ ] پیام «سفارشی از مسیر ترب ثبت نشده» بعد از ذخیره API سفارش طبیعی است تا اولین خرید با `?torob_clid=`
