...
- Last verified: 2026-09-22 — **TASK-20260922-002 CLOSED** on `origin/master` + VPS `dc639b3`. Admin `/admin/partners` edit (including login phone) and guarded delete. Health 200; `.com` 200; `www` `.ir` 200. `/admin/partners` 307 to login. Admin click not exercised. Claims released.
