...
- Last verified: 2026-09-22 — **TASK-20260922-003 implementing** on `feat/TASK-20260922-003-sales-partner-program`. Phases 1–6 coded; Phase 7 hardening: no phantom reversal, RMA line reversal, discounted snapshot, AES-GCM IBAN. Independent Reviewer (`6f63b59f`) conditional approve flag-OFF; Security (`086a7a9b`) no critical/high. Feature flag default OFF. Not live. E2E/a11y and `SALES_PARTNER_IBAN_KEY` in prod still open. Vendor `/partners` unchanged.
