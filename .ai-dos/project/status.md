...
- Last verified: 2026-09-23 — **TASK-20260922-003 merging** `feat/TASK-20260922-003-sales-partner-program` into `master` for flag-OFF deploy. Vendor `/partners` unchanged. Legal terms still `draft-unreviewed`. `SALES_PARTNER_IBAN_KEY` required before LIVE IBAN save.
