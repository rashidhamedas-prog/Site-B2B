...
- Last verified: 2026-09-22 — **TASK-20260922-003 implementing** on `feat/TASK-20260922-003-sales-partner-program`. Phases 1–3 coded: apply/review, catalog+rules+margin guard, draft+SMS+customer confirm+`OrderService.create` convert (`RETAIL_WEBSITE`, no `affiliateId`). Feature flag default OFF. Not live. No order.entity columns (attribution via draft.convertedOrderId + notes). Independent Reviewer + Security required. Vendor `/partners` unchanged.
