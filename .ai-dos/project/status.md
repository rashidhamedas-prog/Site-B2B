...
- Last verified: 2026-09-10 — **TASK-20260910-001 CLOSED** on `origin/master` + VPS `45e32e4`. PDP «راهنما» rows above description; wholesale related `WholesaleProductCard`. Columns `imageUrl`/`excerpt` present. Health 200. Claims released.
