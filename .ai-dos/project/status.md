...
- Last verified: 2026-09-06 — **TASK-20260905-003** write-only token cards **LIVE** `a88672b`: Telegram/Bale/Rubika password fields on `/admin/omnichannel` step ۱; health 200; secrets unauth 401. Telegram still from env; Bale/Rubika wait for owner paste. Independent security still required. TASK-20260826-001 still **NOT DONE**.
