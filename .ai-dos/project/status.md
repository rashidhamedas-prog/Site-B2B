...
- Last verified: 2026-09-23 — **TASK-20260922-003 implementing** on `feat/TASK-20260922-003-sales-partner-program` (`c742c94`+). Phases 1–6 coded; Phase 7: partner/admin labels follow retail FSM + hold/available overlay; open drafts warn on price/stock drift. Flag default OFF. Not live. Browser E2E, prod `SALES_PARTNER_IBAN_KEY`, legal terms, and order-table attribution columns still open. Vendor `/partners` unchanged.
