...
- Last verified: 2026-09-23 — **TASK-20260922-003 implementing** on `feat/TASK-20260922-003-sales-partner-program`. Attribution columns on `orders` added; convert stamps `SALES_PARTNER` and clears `affiliateId`. Admin attribution change locked after earned commission. Prod IBAN save requires `SALES_PARTNER_IBAN_KEY`. Flag default OFF. Browser E2E and legal terms still open. Vendor `/partners` unchanged.
