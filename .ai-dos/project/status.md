...
- 2026-09-06 TASK-20260903-004 shipping: dual-site mobile LCP/INP root-fix coded in `D:/proje/Site-B2B-gsc-speed`. Reviewer + Security **PASS WITH CONDITIONS**. Live deploy, staged image backfill, `.ir` Cloudflare, three-run lab profiles, and GSC LCP/INP validation are the remaining gates. Do not claim 28-day field CWV recovery.
